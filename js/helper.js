...
var HTMLskillsStart = '<h2 id="skillsH2">Skills</h2>';
var HTMLskills = '<div class="black-text">%data%</div>';

var HTMLworkStart = '<div class="work-entry"></div>';
var HTMLworkEmployer = '<h4>%data%<h4>';
var HTMLworkTitle = '<h5>%data%</h5>';
...
var HTMLschoolDegree = '<h5>%data%</h5>';
var HTMLschoolDates = '<div class="date-text">%data%</div>';
var HTMLschoolLocation = '<div class="location-text">%data%</div>';
var HTMLschoolMajor = '<h5>Major: %data%<h5>';
var HTMLschoolURL = '<br><a href="#">%data%</a>';

var HTMLonlineClasses = '<div id="online"<h2>Online Classes</h2></div>';
var HTMLonlineTitle = '<h4>%data%</h4>';
var HTMLonlineSchool = '<h5>%data%</h5>';
